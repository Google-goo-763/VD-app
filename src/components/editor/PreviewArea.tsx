...full file...
＜/dyad-write>
</think><dyad-write path="src/components/editor/PreviewArea.tsx" description="Remove Video, AudioLines, and Image icons from the dropdown button, leaving only the Crown icon">
"use client";
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex items-center justify-center p-6 md:p-12">
        <motion.div          layout          className={`bg-[#1a1a1a] flex items-center justify-center rounded-2xl border border-white/5 transition-all duration-500 ease-in-out shadow-[0_0_50px_rgba(0,0,0,0.5)] overflow-hidden relative group ${
            selectedRatio === '16:9'
      ...
      {/* Preview Controls */}
      <div        className={`grid grid-cols-3 items-center px-6 py-1.5 bg-[#0a0a0a]/80 backdrop-blur-xl border-t border-white/5 ${
          isMaximized ? 'pb-4' : ''
        }`}
      >
        {/* Left Controls */}
