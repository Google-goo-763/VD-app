...
const PreviewArea = () => {
  return (
    <div className="flex flex-col bg-black relative h-[35vh]">
      {/* Video Placeholder */}
      <div className="flex-1 flex items-center justify-center p-4">
        <div className="w-full aspect-video bg-[#1a1a1a] flex items-center justify-center rounded-lg border border-white/5">
