  ...
  return (
    <aside className="h-16 bg-[#121212] border-t border-white/5 flex items-center">
      <div className="flex-1 flex items-center h-full px-2">
        ...
        <SidebarItem icon={Split} label="Split" />
        <SidebarItem icon={Layout} label="Basic" />
        <SidebarItem icon={SlidersHorizontal} label="Adjust" />
        <SidebarItem icon={PictureInPicture} label="PIP" />
        <SidebarItem icon={Crop} label="Crop" />
        <SidebarItem icon={Volume} label="Volume" />
        <SidebarItem icon={Gauge} label="Speed" />
        <SidebarItem icon={Delete} label="Delete" />
      </div>
    </aside>
  );
};
